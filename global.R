...
general.prep.origional <- function(spectra.line.table, element.line) {
...
if(is.na(spectra.line.table)==TRUE){
    NA
}else{
    general.prep.origional(spectra.line.table=spectra.line.table, element.line=element.line)
}
...
simple.tc.prep.origional <- function(data,spectra.line.table, element.line) {
...
if(is.na(spectra.line.table)==TRUE){
    ...
    simple.tc.prep.origional(data=data, spectra.line.table=spectra.line.table, element.line=element.line)
}
...
simple.comp.prep.origional <- function(data, spectra.line.table, element.line, norm.min, norm.max) {
...
if(is.na(spectra.line.table)==TRUE){
    ...
    simple.comp.prep.origional(data=data, spectra.line.table=spectra.line.table, element.line=element.line, norm.min=norm.min, norm.max=norm.max)
}
...
lucas.simp.prep.origional <- function(spectra.line.table, element.line, slope.element.lines, intercept.element.lines) {
...
if(is.na(spectra.line.table)==TRUE){
    ...
    lucas.simp.prep.origional(spectra.line.table=spectra.line.table, element.line=element.line, slope.element.lines=slope.element.lines, intercept.element.lines=intercept.element.lines)
}
...
lucas.tc.prep.origional <- function(data, spectra.line.table, element.line, slope.element.lines, intercept.element.lines) {
...
if(is.na(spectra.line.table)==TRUE){
    ...
    lucas.tc.prep.origional(data=data, spectra.line.table=spectra.line.table, element.line=element.line, slope.element.lines=slope.element.lines, intercept.element.lines=intercept.element.lines)
}
...
lucas.comp.prep.origional <- function(data, spectra.line.table, element.line, slope.element.lines, intercept.element.lines, norm.min, norm.max) {
...
if(is.na(spectra.line.table)==TRUE){
    ...
    lucas.comp.prep.origional(data=data, spectra.line.table=spectra.line.table, element.line=element.line, slope.element.lines=slope.element.lines, intercept.element.lines=intercept.element.lines, norm.min=norm.min, norm.max=norm.max)
}
...
T4S2480.cal <- readRDS("data/Cals/T4S2480.quant")
T4S2481.cal <- readRDS("data/Cals/T4S2481.quant")
